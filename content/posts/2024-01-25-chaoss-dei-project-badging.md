---
title: CHAOSS DEI Project Badging
author:
  - elizabeth
type: post
date: 2024-01-25T20:49:29+00:00
url: /chaoss-dei-project-badging/
...
### **Self-Assessment and Documentation** {.wp-block-heading}

Before applying for a CHAOSS Project DEI Badge, maintainers or project admins are encouraged to conduct a self-assessment of their project&#8217;s DEI efforts based on the following CHAOSS DEI metrics: [Project Access][2], [Inclusive Leadership][3], [Communication Transparency][4], and [Newcomer Experience][2]. After the self-assessment, maintainers can document how the project attends to and prioritizes DEI around these areas in a markdown file called the [DEI.md file][5]. This DEI.md file should exist within the project&#8217;s repository for easy feedback from the community. A guide for putting together your DEI.md file is available through the [DEI.md Guide][6]. 

### **Badging Application** {.wp-block-heading}

Once the DEI.md file is published and publicly available, project owners can proceed to [apply here][7]. The applicant must be a project owner and the repository that holds the DEI.md file must be specified.

### **Badging Evaluation** {.wp-block-heading}
...
### **Recognition and Badging** {.wp-block-heading}
...
### **Continued Engagement** {.wp-block-heading}

...
<div align="center">
<img src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/priority-formula.png?raw=true" alt="Priority = Criticality X Health Risk" title="Priority = Criticality X Health Risk" />
</div>
...
| :--- | :--- |
| **High (8 - 10)** | <ul><li>Critical to core functions</li><li>High usage rates across the organization</li><li>Extremely difficult to swap or maintain internally</li><li>Difficult to backfill expertise</li><li>Roadmap has features that would be very beneficial to organization</li></ul> |
| **Moderate (4 - 7)** | <ul><li>Software that supports core functionality</li><li>Could be swapped out with reasonable effort</li><li>Easy to backfill expertise</li></ul> |
| **Low (1 - 3)** | <ul><li>Non-essential tools/apps with minimal organizational impact</li><li>Could be swapped out with minimal effort (API compatible)</li></ul> |
...
<table style="width: 100%; border-collapse: collapse; border: 1px solid #ddd;">
  <thead>
    <tr style="background-color: #f2f2f2;">
      ...
      <th style="border: 1px solid #ddd; padding: 8px;">Dependency</th>
      <th style="border: 1px solid #ddd; padding: 8px;">Opportunity</th>
      <th style="border: 1px solid #ddd; padding: 8px;">Supportability</th>
      <th style="border: 1px solid #ddd; padding: 8px;">Health Risk</th>
    </tr>
  </thead>
  <tbody>
    <!-- Foo Section -->
    <tr>
      <td rowspan="2" style="border: 1px solid #ddd; padding: 8px; font-weight: bold; vertical-align: top;">Foo (50)</td>
      <td colspan="3" style="border: 1px solid #ddd; padding: 8px; font-weight: bold;">Criticality: 8.3 (average of 10, 7, and 8)</td>
      <td style="border: 1px solid #ddd; padding: 8px; font-weight: bold; vertical-align: top;">Health Risk: 6</td>
    </tr>
    <tr>
    ...
    <!-- Bar Section -->
    <tr>
      <td rowspan="2" style="border: 1px solid #ddd; padding: 8px; font-weight: bold; vertical-align: top;">Bar (21)</td>
      <td colspan="3" style="border: 1px solid #ddd; padding: 8px; font-weight: bold;">Criticality: 7 (average of 6, 9, and 6)</td>
      <td style="border: 1px solid #ddd; padding: 8px; font-weight: bold; vertical-align: top;">Health Risk: 3</td>
    </tr>
    <tr>
      <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">
        <ul style="margin: 0; padding-left: 20px;">
...
<div align="center">
<img src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/putting-together-formula.png?raw=true" alt="Priority = Criticality X Health Risk" title="Resources you have available" />
</div>
...
| Type | Metric | Source |
| :--- | :--- | :--- |
| Bugs | <ul><li>[Bugs reported vs resolved](https://chaoss.community/?p=3633)</li><li>[Time to resolution](https://chaoss.community/?p=3630)</li><li>What % are resolved by your org vs others</li></ul> | Bugs closed this year (GitHub Query): **is:issue closed:2024-01-01..2024-11-01 label:kind/bug** |
| Security | <ul><li>[Security issues reported vs resolved](https://chaoss.community/?p=3633)</li><li>[Time to resolution](https://chaoss.community/?p=3630)</li></ul> | Time to resolve security issues (GitHub cli tool): **gh issue list –search “is:closed label:security” –json “id,openedAt, closedAt”** |
| Issue / Change Request | <ul><li>[Time to resolution](https://chaoss.community/?p=3587)</li><li>What % are resolved by your org vs others</li></ul> | GitHub queries can be tailored with **author:** keyword look at organization created items to track own items vs. project as a whole.<br/><br/>Issues/PR queries can be tailored to track initiatives |
...
<div align="center">
<img src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/conclusion-communication.png?raw=true" alt="Summary of a report communicating the value of contributions to Foo and Bar" title="Report Summary" />
</div>
...
CHAOSS Practitioner Guides are MIT licensed, living documents, and we welcome your feedback and input. You can suggest edits to this document at [https://github.com/chaoss/hugo/blob/main/content/practitioner%20guides/practitioner-guide-demonstrating-org-value.md](https://github.com/chaoss/hugo/blob/main/content/practitioner%20guides/practitioner-guide-demonstrating-org-value.md).

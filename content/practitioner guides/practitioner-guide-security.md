...
nectar-metabox-portfolio-display-sortable:
  - off
url: /practitioner-guide-security
---
...
Primary metrics:
  ...
  * [OpenSSF Best Practices Badge][1] 
  * [Libyears][2] 
  * [Release Frequency][3]
...
Security is a complex topic, but you can start by looking at a few key metrics. First, the [OpenSSF Best Practices Badging][1] criteria creates a good engineering foundation that incoporates basic security practices. Second, when you use outdated dependencies, you are four times as likely to have security issues (Cox et al. 2015), so using the [Libyears][2] metric can help you understand if you are keeping your dependencies up to date. Third, [Release Frequency][3] helps gauge whether your security fixes and other updates are landing in a release in a timely manner so that your users can benefit from your security updates.

## OpenSSF Best Practices

The [Open Source Security Foundation][5] (OpenSSF) provides ways to assess your open source project across a number of different dimensions to get a summary of where your project’s practices can be improved. While security practices are an important component, the [OpenSSF Best Practices Badge][1] goes beyond just security to suggest a range of best practices for your project. It’s a good way to not only assess your security practices and improve on them to meet the badge criteria, but it also signals to your users that you follow OpenSSF best practices. The criteria found in the reporting, security, and analysis sections are the ones that are most applicable to understanding and improving the security of your project. 

<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/ossf-badge-curl.png?raw=true" alt="Open SSF Badge example of gold badge from the curl project" /> 

Image Source: [<https://www.bestpractices.dev/en/projects/63>][6] 

## Libyears

The [Libyears][7] metric explains the age of dependencies that you rely on, compared to the current stable releases of those dependencies. It was first proposed in “Measuring Dependency Freshness in Software Systems” (Cox et al. 2015). In general, a lower Libyear number is better because it indicates that you are keeping your dependencies up to date. 

<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/libyears.png?raw=true" alt="Libyear example of a project that is 103.78 years behind" /> 

Image Source: [<https://github.com/nasirhjafri/libyear>][8] 
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/releases.png?raw=true" alt="Release Frequency of a project with frequent releases" /> 
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/ossf-badge-categories.png?raw=true" alt="OSSF Badging list of categories for a project that is working toward a badge, but has more work to do" /> 

Image Source: [<https://www.bestpractices.dev/en/projects/40>][9] 
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/ossf-badge-criteria-example.png?raw=true" alt="OSSF Badging criteria from the security section for MITM attacks and vulnerabilities fixed" /> 

Whether you decide to pursue the badge or not, the [criteria][10] used, especially in the security and reporting sections, are a good way to think about how you might understand and improve the security of your project. There are also other options to perform security self-assessments for your projects, including the [self-assessment that the CNCF][11] uses for their projects.
...
The examples used in Steps 1 and 2 provide a starting point that can be expanded by using additional tools and metrics. A good next step in the diagnostic process would be to also run the [OpenSSF Scorecard][12], which goes into great detail with checks that help you find areas where your project might be vulnerable across source code, build, dependencies, testing, and project maintenance categories.
...
As mentioned earlier, working your way through the OpenSSF Best Practices badge criteria is a good way to make security improvements. The [detailed view of the criteria page for all levels][10] contains explanations and links with more details that can help you improve in each of those areas.
...
Because security is such a complex topic, it can be difficult to monitor. However, there are a few things that you can monitor over time to see if the actions you’ve taken to improve your security are having an impact. Here are a few suggestions for monitoring your progress:
  ...
  * [OpenSSF Scorecard][12]: Has your overall score improved? Have you improved your score on some of the individual areas that you identified for improvement? 
...
# Additional Reading
  ...
  * We have a [short video][23] (<4 minutes) devoted to this guide on the CHAOSS YouTube channel.
  * [CHAOSScast Episode][24] about this guide.
  * [OpenSSF’s website][5] contains a wide variety of very detailed guides, training, and other resources. 
  * The [CNCF Security Guidelines][25] document is much less comprehensive than the OpenSSF guides, but it might be more helpful if you are just starting to improve your security. 
  * [OpenSSF’s OSS Vulnerability Guide][20] contains a guide along with templates and a runbook focused on developing and implementing a security policy.

# Feedback

We would love to have feedback to learn more about how people are using the CHAOSS Practitioner Guides and how we can improve them over time. Please complete this [short survey][26] to provide your feedback.
...
# References
  ...
  * Cox, J., Bouwers, E., Van Eekelen, M., & Visser, J. (2015, May). [Measuring dependency freshness in software systems][27]. In _2015 IEEE/ACM 37th IEEE International Conference on Software Engineering_ (Vol. 2, pp. 109-118). IEEE. 
  * Imtiaz, N., Khanom, A., & Williams, L. (2022). [Open or sneaky? fast or slow? light or heavy?: Investigating security releases of open source packages][28]. _IEEE Transactions on Software Engineering_, _49_(4), 1540-1560. 
  * Synopsys (2024). [Open Source Security and Risk Analysis Report][29]. 
  * Zerouali, A., Mens, T., Gonzalez‐Barahona, J., Decan, A., Constantinou, E., & Robles, G. (2019). [A formal framework for measuring technical lag in component repositories—and its application to npm][30]. _Journal of Software: Evolution and Process_, _31_(8), e2157.
...
\[/vc\_column\]\[/vc\_row\]
 ...
 [1]: https://chaoss.community/?p=3939
 [2]: https://chaoss.community/?p=3976
 [3]: https://chaoss.community/?p=4765
 [4]: https://chaoss.community/practitioner-guide-introduction/
 [5]: https://openssf.org/
 [6]: https://www.bestpractices.dev/en/projects/63
 [7]: https://chaoss.community/kb/metric-libyears/
 [8]: https://github.com/nasirhjafri/libyear
 [9]: https://www.bestpractices.dev/en/projects/40
 [10]: https://www.bestpractices.dev/en/criteria?details=true&rationale=true
 [11]: https://github.com/cncf/tag-security/blob/main/community/assessments/guide/self-assessment.md
 [12]: https://scorecard.dev/
 [13]: https://chaoss.community/?p=3610
 [14]: https://chaoss.community/?p=4727
 [15]: https://chaoss.community/?p=3968
 [16]: https://chaoss.community/?p=3977
 [17]: https://best.openssf.org/SCM-BestPractices/
 [18]: https://docs.github.com/en/code-security/getting-started/adding-a-security-policy-to-your-repository
 [19]: https://aliceevebob.com/2018/01/09/meltdown-and-spectre-thinking-about-embargoes-and-disclosures/
 [20]: https://github.com/ossf/oss-vulnerability-guide/tree/main
 [21]: https://github.blog/2020-06-01-keep-all-your-packages-up-to-date-with-dependabot/
 [22]: https://docs.renovatebot.com/
 [23]: https://www.youtube.com/watch?v=1FPlivLsrls&list=PL60k37cxI-HSHV4-rEsWMzExw2y2Oq79Z&index=5&pp=iAQB
 [24]: https://podcast.chaoss.community/97
 [25]: https://contribute.cncf.io/maintainers/security/security-guidelines/
 [26]: https://forms.gle/w3B1gBH8kp3rPbhr8
 [27]: https://repository.ubn.ru.nl/bitstream/handle/2066/143749/143749.pdf?sequence=1
 [28]: https://arxiv.org/pdf/2112.06804
 [29]: https://www.synopsys.com/software-integrity/resources/analyst-reports/open-source-security-risk-analysis.html#introMenu
 [30]: https://www.academia.edu/download/101718334/jsep-2019.pdf
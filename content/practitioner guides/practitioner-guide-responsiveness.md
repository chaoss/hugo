...
ppma_authors_name:
  - elizabeth
url: /practitioner-guide-responsiveness
---
...
Primary metrics:
  ...
  * [Time to First Response][1]
  * [Time to Close][2]
  * [Change Request Closure Ratio][3]
...
While there are also complex ways of looking at responsiveness, getting started with responsiveness metrics can be straightforward if you start by identifying the trends. By looking at [Time to First Response][1], [Time to Close][2], and [Change Request Closure Ratio][3] together, you can get a sense of whether contributors are getting a timely response and whether you are keeping up with contributions by closing change requests (merged or closed without merge).
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/time-to-first-response.png?raw=true" alt="Time to First Response showing that most PRs are closed within 2 business days" title="Time to First Response - generated by Augur" /> 
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/time-to-close.png?raw=true" alt="Average time to close of 8.941 days and Median time to close of 4.022 days" title="Time to Close - generated by GrimoireLab" /> 
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/closure-ratio-summer-gap.png?raw=true" alt="Closure Ratio - sustains and keeps up with contributions showing that they are falling behind in July and August" title="Closure Ratio - generated by Augur" /> 
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/closure-ratio-falling-behind.png?raw=true" alt="Closure Ratio - sustains and keeps up with contributions showing that the project has gradually stopped keeping up" title="Closure Ratio - generated by Augur" /> 
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/lead-time.png?raw=true" alt="Lead time showing time to close gradually increasing" title="Lead Time - generated by GrimoireLab" /> 
...
Metrics: 
  ...
  * [Review Cycle Duration within a Change Request][5]
  * [Change Requests Duration][6]
  * [Change Request Review Duration][7]
  * [Issue Response Time][8]
  * [Issue Resolution Duration][9]
  * [Defect Resolution Duration][10]
...
Another way to reduce reviewer friction and make it easier for maintainers to review contributions is by using [issue and change request templates][14] to help contributors make good contributions that require less work from maintainers. Here are a [few examples of the types of things][15] you might want to include in these templates and in your contributor guides:
...
# Additional Reading
  ...
  * We have a [short video][16] (< 3 minutes) devoted to this guide on the CHAOSS YouTube channel.
  * [CHAOSScast episode][17] about this guide.
  * The [Contributor Sustainability Practitioner Guide][13] has more details about recruiting contributors and moving them into leadership roles, like reviewer and maintainer.
  * [CHAOSScast episode about this responsiveness guide][17]
  * [Measuring Open Source project health][18] has a section about responsiveness.
  * [Anatomy of a Perfect Pull Request][15] for more ideas about guidance you might give to help people make better contributions that are easier for maintainers to review.

# Feedback

We would love to have feedback to learn more about how people are using the CHAOSS Practitioner Guides and how we can improve them over time. Please complete this [short survey][19] to provide your feedback.
...
# References
  ...
  * Dabbish, L., Stuart, C., Tsay, J., & Herbsleb, J. (2012, February). [Social coding in GitHub: transparency and collaboration in an open software repository][20]. In Proceedings of the ACM 2012 conference on computer supported cooperative work (pp. 1277-1286).
  * Eghbal, Nadia (2020). [Working in Public: The Making and Maintenance of Open Source Software][21]. Stripe Press.
  * Fronchetti, F., Wiese, I., Pinto, G., & Steinmacher, I. (2019). [What attracts newcomers to onboard on oss projects? tl; dr: Popularity][22]. In Open Source Systems: 15th IFIP WG 2.13 International Conference, OSS 2019, Montreal, QC, Canada, May 26–27, 2019, Proceedings 15 (pp. 91-103). Springer International Publishing.
...
\[/vc\_column\]\[/vc\_row\]
 ...
 [1]: https://chaoss.community/?p=3448
 [2]: https://chaoss.community/?p=3446
 [3]: https://chaoss.community/?p=4834
 [4]: https://chaoss.community/practitioner-guide-introduction/
 [5]: https://chaoss.community/?p=3445
 [6]: https://chaoss.community/?p=3587
 [7]: https://chaoss.community/?p=4920
 [8]: https://chaoss.community/?p=3631
 [9]: https://chaoss.community/?p=3630
 [10]: https://chaoss.community/?p=4727
 ...
 [13]: https://chaoss.community/practitioner-guide-contributor-sustainability/
 [14]: https://docs.github.com/en/communities/using-templates-to-encourage-useful-issues-and-pull-requests/about-issue-and-pull-request-templates
 [15]: https://opensource.com/article/18/6/anatomy-perfect-pull-request
 [16]: https://www.youtube.com/watch?v=lLx8l6F-Muk&list=PL60k37cxI-HSHV4-rEsWMzExw2y2Oq79Z&index=4
 [17]: https://podcast.chaoss.community/85
 [18]: https://opensource.net/measure-open-source-project-health/
 [19]: https://forms.gle/w3B1gBH8kp3rPbhr8
 [20]: https://www.lri.fr/~mbl/ENS/CSCW/2012/papers/Dabbish2012.pdf
 [21]: https://nadia.xyz/oss/
 [22]: https://inria.hal.science/hal-02305705/document
...
nectar-metabox-portfolio-display-sortable:
  - off
url: /practitioner-guide-diverse-leadership
---
...
You can determine whether your project’s roles are designed with [inclusive leadership][3] in mind, in addition to assessing the level of diversity of the people in the top leadership positions, by looking at [Board/Council Diversity.][1] You should also look at how people in leadership use their position to advocate for and bring up the next generation of leaders through personalized [sponsorship][2] opportunities. 
...
Sponsorship is the active process by which those in leadership advocate for and bring up the next row of leaders, providing them with personalized growth opportunities_._ This _action_ by current leaders to actively support and promote the next generation of leaders should be visible and measured over time to track the impact on a community. In any community with active sponsorship, members feel valued, and the rate of contributor retention is high. It also brings about growth and sustainability. 
...
Additional Metrics: 
  ...
  * [Mentorship][5]
  * [Code of Conduct for a Project][6]
...
As you monitor the results of your efforts to enhance diverse leadership, it's important to consider key aspects to ensure your approach is effective, respectful, and sustainable. The data you collect will provide valuable insight, but interpreting and acting upon it requires careful thought.
  ...
  5. Finally, when working with data about people, especially those from underrepresented groups, prioritize privacy and ethical considerations. When using data about people, especially those from underrepresented groups, it is important to be mindful of how the data is collected, stored, used, and shared (Casari et al. 2023). Privacy and ethical concerns should be carefully considered. The CHAOSS project has a [Data Use Awareness Recommendations: Privacy and Ethics][9] document that can serve as an example of these concerns.

# Additional Reading

  * [CHAOSScast Episode 124: Practitioner Guides: #7 Diverse Leadership][10]
  * [Diversity, Equity, and Inclusion in Open Source][11]
  * [Linux Foundation - Decentralized innovation, built with trust][12]
  * [Inclusive Leadership: Effecting change: Introduction | OpenLearn - Open University][13]
  * [CHAOSS Data Use Awareness Recommendations: Privacy and Ethics][9]
  * We have a [short video][14] (5 minutes) devoted to this guide on the CHAOSS YouTube channel.
...
# References
  ...
  * Casari, A., Ferraioli, J., & Lovato, J. (2023). [Beyond the repository: Best practices for open source ecosystems researchers][15]. Queue, 21(2), 14-34.
  * Donnelly, G. (2017). [Study: Just the Perception of Implicit Bias Takes a Toll on Companies][16]. Fortune.
  * Linux Foundation (2021). [Diversity, equity, and inclusion in open source][11].
  * Izquierdo, D., Huesman, N., & Price, A. (2017). [Gender Diversity Analysis in the][17]. [OpenStack Community][17]. Superuser. 
  * McKinsey & Company. (2020). _Diversity still matters._ Retrieved from [<https://www.mckinsey.com/featured-insights/diversity-and-inclusion/diversity-still-matters>][18]
...
\[/vc\_column\]\[/vc\_row\]
 ...
 [1]: https://chaoss.community/?p=3516
 [2]: https://chaoss.community/?p=3523
 [3]: https://chaoss.community/?p=3522
 [4]: https://chaoss.community/practitioner-guide-introduction/
 [5]: https://chaoss.community/?p=3524
 [6]: https://chaoss.community/?p=3517
 [7]: https://chaoss.community/?p=3544
 [8]: https://chaoss.community/?p=3537
 [9]: https://github.com/chaoss/community/blob/main/data-use-statement.md
 [10]: https://podcast.chaoss.community/124
 [11]: https://www.linuxfoundation.org/research/the-2021-linux-foundation-report-on-diversity-equity-and-inclusion-in-open-source
 [12]: https://www.linuxfoundation.org/
 [13]: https://www.open.edu/openlearn/education-development/inclusive-leadership-effecting-change/content-section-0?intro=1
 [14]: https://www.youtube.com/watch?v=NSBKSFToV7k&list=PL60k37cxI-HSHV4-rEsWMzExw2y2Oq79Z&index=7
 [15]: https://cacm.acm.org/practice/beyond-the-repository/
 [16]: https://fortune.com/2017/07/13/implicit-bias-perception-costs-companies/
 [17]: https://superuser.openinfra.dev/wp-content/uploads/2017/07/OpenStack-Gender-Diversity-Report_Apr2017.pdf
 [18]: https://www.mckinsey.com/featured-insights/diversity-and-inclusion/diversity-still-matters
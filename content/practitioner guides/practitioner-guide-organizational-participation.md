---
title: Practitioner Guide – Organizational Participation
author: elizabeth
type: page
date: 2024-04-29T17:40:00+00:00
...
ppma_authors_name:
  - elizabeth
url: /practitioner-guide-organizational-participation
---
...
A good starting point is to look at the [Elephant Factor][3] to determine how the work is distributed among multiple organizations along with [Organizational Diversity][2] to look at which organizations are making contributions. Finally, it’s also important to think about [Organizational Influence][1] to understand which organizations have employees in leadership or other decision making positions.
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/commit-activity-by-domain-vmw.png?raw=true" alt="Commit Activity by Domain pie chart showing VMware at 70.5%, gmail.com at 16.3%, users.noreply.github.com at 4.52, other at 4.32%" title="Commit Activity by Domain - generated by 8Knot / Augur" /> 
...
<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/active-organizations-over-time-by-data-source.png?raw=true" alt="Active Organizations over Time by Data Source across GitHub PRs / Issues, Slack, and pipermail" title="Active Organizations over Time - generated by GrimoireLab" /> 

## Organizational Influence

Organizational Influence is a measure of the influence that an organization has on an open source community. It can be harder to measure than some other metrics because it usually involves looking at the organizations that employ people in leadership roles (e.g., boards, working groups, maintainers, committers). In most cases this will require a manual assessment by looking at the governance or other documentation that has details about leadership positions. For a few projects, this can be easier when the leadership data is stored in files with structured data, like in the following example of [Istio Leadership Positions][5]. As you can see in the Istio example, it can be useful to look at how organizational influence evolves over time.

**April 2022 before Istio joined the CNCF as an Incubating project on September 30:**

<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/leadership-positions-istio-before-cncf-april-2022.png?raw=true" alt="Istio Leadership Positions (SC, TOC, WG Lead) 26 people across 9 companies - 12 at Google, 4 IBM" title="Istio Leadership - custom analysis" /> 

**June 2023 just before they were accepted as a CNCF Graduated project on July 12**:

<img decoding="async" src="https://github.com/chaoss/wg-data-science/blob/main/practitioner-guides/images/leadership-positions-istio-graduating-june-2023.png?raw=true" alt="Istio Leadership Positions (SC, TOC, WG Lead) 26 people across 11 companies - 7 at Google, 5 at Solo.io, 4 IBM" title="Istio Leadership - custom analysis" /> 
...
Additional Metrics: 
  ...
  * [Contribution Attribution][8]
  * [Job Opportunities][9]
  * [Labor Investment][10]
  * [Organizational Project Skill Demand][11]
...
# Additional Reading
  ...
  * [CHAOSScast episode][14] about this guide.
  * The [Contributor Sustainability Practitioner Guide][12] has suggestions that can also be applied to encouraging contributions from employees at other organizations. 
  * Gary White wrote a several part [blog post series][15] on how to think about assessing project viability, and in particular, the [Metrics for OSS Viability][16] post is relevant for this topic.

# Feedback

We would love to have feedback to learn more about how people are using the CHAOSS Practitioner Guides and how we can improve them over time. Please complete this [short survey][17] to provide your feedback.
...
# References
  ...
  * Eghbal, N. (2016). [Roads and Bridges: The Unseen Labor Behind Our Digital Infrastructure][18]. New York, NY: Ford Foundation.
  * Fagerholm, F., Guinea, A. S., Münch, J., & Borenstein, J. (2014, September). [The role of mentoring and project characteristics for onboarding in open source software projects][19]. In Proceedings of the 8th ACM/IEEE international symposium on empirical software engineering and measurement (pp. 1-10). 
  * Foster, D. (2024, November 13-14). [The New Dynamics of Open Source: Relicensing, Forks, and Community Impact][20]. OpenForum Academy Symposium 2024, Boston, Massachusetts.
  * Miller, C., Widder, D. G., Kästner, C., & Vasilescu, B. (2019). [Why do people give up flossing? a study of contributor disengagement in open source][21]. In Open Source Systems: 15th IFIP WG 2.13 International Conference, OSS 2019, Montreal, QC, Canada, May 26–27, 2019, Proceedings 15 (pp. 116-129). Springer International Publishing.
...
\[/vc\_column\]\[/vc\_row\]
 ...
 [1]: https://chaoss.community/?p=3560
 [2]: https://chaoss.community/?p=3464
 [3]: https://chaoss.community/?p=3940
 [4]: https://chaoss.community/practitioner-guide-introduction/
 [5]: https://github.com/geekygirldawn/k8s_data/blob/main/datasets/Istio_Leadership_Analysis.ipynb
 [6]: https://github.com/chaoss/grimoirelab-sortinghat
 [7]: https://github.com/cncf/gitdm
 [8]: https://chaoss.community/?p=3616
 [9]: https://chaoss.community/?p=3567
 [10]: https://chaoss.community/?p=3559
 [11]: https://chaoss.community/?p=3566
 [12]: https://chaoss.community/practitioner-guide-contributor-sustainability/
 [13]: https://www.youtube.com/watch?v=mztEQMgam5Y&list=PL60k37cxI-HSHV4-rEsWMzExw2y2Oq79Z&index=4
 [14]: https://podcast.chaoss.community/89
 [15]: https://chaoss.community/author/garywhite/
 [16]: https://chaoss.community/viability-metrics-what-its-made-of/
 [17]: https://forms.gle/w3B1gBH8kp3rPbhr8
 [18]: https://www.fordfoundation.org/work/learning/research-reports/roads-and-bridges-the-unseen-labor-behind-our-digital-infrastructure/
 [19]: https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=2096b22e7a465eec6ece0933acefebffc286d1f2
 [20]: https://doi.org/10.48550/arXiv.2411.04739
 [21]: https://inria.hal.science/hal-02305702/file/484969_1_En_11_Chapter.pdf
---
title: Practitioner Guide – Introduction
author: elizabeth
type: page
date: 2024-04-29T17:40:55+00:00
...
ppma_authors_name:
  - elizabeth
url: /practitioner-guide-introduction
---
...
# Additional Reading
  ...
  * [Practitioner Guide series][5] with guides to help you improve responsiveness, contributor sustainability, organizational participation, and more.
  * A short video about each guide can be found in the [Practitioner Guides Playlist][6] in the CHAOSS YouTube channel.
  * An episode of the [SustainOSS podcast][7] about the Practitioner Guide series.
  * For more cautions, considerations, and best practices, please read [Beyond the Repository][3] by Amanda Casari, Julia Ferraioli, and Juniper Lovato.
  * Video of a panel related to developing a [metrics strategy for your OSPO][2] and a blog post about [building an open source strategy][8] and using metrics to determine success. 
  * [CHAOSS Software][4]

# Feedback

We would love to have feedback to learn more about how people are using the CHAOSS Practitioner Guides and how we can improve them over time. Please complete this [short survey][9] to provide your feedback.
...
# References
  ...
  * Casari, A., Ferraioli, J., & Lovato, J. (2023). [Beyond the repository: Best practices for open source ecosystems researchers][10]. Queue, 21(2), 14-34.
  * Goggins, S. P., Germonprez, M., & Lumbard, K. (2021). [Making open source project health transparent][11]. Computer, 54(8), 104-111.
  * Linåker, J., Papatheocharous, E., & Olsson, T. (2022, September). [How to characterize the health of an Open Source Software project? A snowball literature review of an emerging practice][12]. In Proceedings of the 18th International Symposium on Open Collaboration (pp. 1-12).
...
\[/vc\_column\]\[/vc\_row\]
 ...
 [1]: https://chaoss.community/kb-metrics-and-metrics-models/
 [2]: https://community.linuxfoundation.org/events/details/lfhq-todo-group-ospology-presents-ways-to-define-a-metrics-strategy-in-your-ospo/
 [3]: https://cacm.acm.org/magazines/2023/10/276630-beyond-the-repository/fulltext
 [4]: https://chaoss.community/software/
 [5]: https://chaoss.community/about-chaoss-practitioner-guides/
 [6]: https://www.youtube.com/playlist?list=PL60k37cxI-HSHV4-rEsWMzExw2y2Oq79Z
 [7]: https://podcast.sustainoss.org/243
 [8]: https://blogs.vmware.com/opensource/2020/03/03/open-source-strategy/
 [9]: https://forms.gle/w3B1gBH8kp3rPbhr8
 [10]: https://cacm.acm.org/practice/beyond-the-repository/
 [11]: https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=9504501
 [12]: https://dl.acm.org/doi/pdf/10.1145/3555051.3555067